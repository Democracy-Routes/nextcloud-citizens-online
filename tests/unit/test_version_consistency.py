...
def test_all_version_declarations_match():
    versions = {
        "citizens_online/__init__.py": citizens_online.__version__,
        ...
        "citizens_online/config.py": _search(
            ROOT / "citizens_online/config.py", r'app_version: str = "([^"]+)"'
        ),
