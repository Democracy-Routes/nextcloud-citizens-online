...
class Finding(Base):
    ...
    scope: Mapped[str] = mapped_column(String(8))  # "room" | "round"
    ...
    # round-scope clusters reference the room findings they aggregate
    source_finding_ids: Mapped[str] = mapped_column(Text, default="[]")
    mentioned_room_count: Mapped[int] = mapped_column(Integer, default=0)
