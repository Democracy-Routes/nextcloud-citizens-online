# Citizens Online — ExApp runtime image.
#
...
COPY citizens_online ./citizens_online
COPY appinfo ./appinfo
# UI bundle: missing it leaves the deployed app unstyled or blank.
COPY js ./js
COPY css ./css
COPY img ./img
...
RUN useradd --system --uid 10001 --home-dir /app citizens_online \
    && mkdir -p /data \
    && chown -R citizens_online:citizens_online /app /data
USER citizens_online
